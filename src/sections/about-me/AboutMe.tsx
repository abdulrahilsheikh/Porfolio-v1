		...
		<div className="bg-white  w-80 shadow-lg  rounded-xl p-4 transition-all hover:shadow-2xl">
			...
			<div className="flex items-center mt-4 gap-2">
				...
				<div className="flex flex-col justify-between ml-2">
					<span className="text-lg md:text-2xl font-semibold text-[#4a4e69]">
						{title}
					</span>
		...
		<div className={`min-h-screen pt-4 pb-20`}>
			...
			<div className="h-full flex items-center ">
				<div className="w-1/2 h-full hidden md:block">
					<div
						className={`${styles.mask1} w-full h-full overflow-hidden`}>
						<img
							src={samurai}
							className="object-cover h-full relative top-0"
						/>
					</div>
				</div>
				{/* cards containers */}
				<div
					className={`w-full md:w-1/2 items-center flex flex-col pt-8 px-8 gap-4 ${styles.cardsContainer}`}>
					<AboutCard
						icon={codeBox}
						content={
